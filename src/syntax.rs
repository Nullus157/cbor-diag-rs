...
impl Tag {
    ...
    /// string](Value::TextString) (or the [indefinite
    /// variant](Value::IndefiniteTextString) of) data item.
    ///
    ...
    /// integer](Value::Integer), [negative integer](Value::Negative) or
    /// [floating point](Value::Float) data item.
    ///
    /// See [RFC 7049 § 2.4.1][RFC 2.4.1] for more details on how to interpret
    /// the value.
    ///
    ...
    /// string](Value::ByteString) (or the [indefinite
    /// variant](Value::IndefiniteByteString) of) data item.
    ///
    ...
    /// A "decimal fraction"; must only be applied to an [array](Value::Array)
    /// containing exactly two data items, the first must be either a [unsigned
    /// integer](Value::Integer) or [negative integer](Value::Negative), the
    /// second can be either of those or additionally a
    ...
    /// A "bigfloat"; must only be applied to an [array](Value::Array)
    /// containing exactly two data items, the first must be either a [unsigned
    /// integer](Value::Integer) or [negative integer](Value::Negative), the
    /// second can be either of those or additionally a
    /// [positive](Tag::POSITIVE_BIGNUM) or [negative](Tag::NEGATIVE_BIGNUM)
    ...
    /// Sets the expected encoding of any [byte strings](Value::ByteString)
    ...
    /// to a [byte string](Value::ByteString) (or the [indefinite
    /// variant](Value::IndefiniteByteString) of) data item.
    ///
    ...
    /// to a [text string](Value::TextString) (or the [indefinite
    /// variant](Value::IndefiniteTextString) of) data item.
    ///
    ...
    /// applied to a [text string](Value::TextString) (or the [indefinite
    /// variant](Value::IndefiniteTextString) of) data item.
    ///
    /// See [RFC 7049 § 2.4.4.3][RFC 2.4.4.3] for more details on what this
    /// means.
